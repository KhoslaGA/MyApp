          ...
          >
            <div className="section__title text-center sp_bottom_80">
              ...
              <div className="section__title__heading contact__heading">
                <h3>Your Digital Success is Just a Click Away!.</h3>
              </div>
            </div>
          </div>
          <div
                ...
                <div className="row">
                  ...
                  <div className="col-xl-12">
                    ...
                    >
                      ...
                      <option value="mercedes">PPC</option>
                      <option value="audi">Content Creation</option>
                    </select>
                  </div>
                  <div className="col-xl-12">
                    <textarea
          ...
          >
            <div className="contact__info">
              ...
              >
                ...
                <div className="contact__text">
                  <h6>Location:</h6>
                  <p>Suite 1400 18 king street East</p>
                  <p>Toronto ON, M5C1C4</p>
                </div>
              </div>
            </div>
            <div
